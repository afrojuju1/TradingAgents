...
def create_market_analyst(llm):
    ...
    def market_analyst_node(state):
        ...
        system_message = (
            """You are a trading assistant tasked with analyzing financial markets. Your role is to select the **most relevant indicators** for a given market condition or trading strategy from the following list. The goal is to choose up to **4 indicators** that provide complementary insights without redundancy. Prefer close_50_sma, close_200_sma, rsi, and macd unless the market context clearly calls for different indicators. Categories and each category's indicators are:
